...
public class MovieItem {
    ...
    private List<MovieGenre> listGenres;
    ...
    public MovieItem(String posterPath, boolean adult, String overview, String releaseDate, List<Integer> genreIds, Integer id,
                     ...
                     Integer voteCount, Boolean video, Double voteAverage, List <MovieGenre> listGenres, String runtime) {
    ...
    public List<MovieGenre> getListGenres() {
        return listGenres;
    }

    public void setListGenres(List<MovieGenre> genres) {
